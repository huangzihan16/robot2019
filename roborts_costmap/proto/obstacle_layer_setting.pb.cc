...
void protobuf_AssignDesc_obstacle_5flayer_5fsetting_2eproto() {
  ...
  static const int ParaObstacleLayer_offsets_[17] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ParaObstacleLayer, map_topic_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ParaObstacleLayer, enemy_inflation_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ParaObstacleLayer, max_occ_dist_),
  };
...
void protobuf_AddDesc_obstacle_5flayer_5fsetting_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "(\010\022\020\n\010is_debug\030\016 \002(\010\022\021\n\tmap_topic\030\017 \002(\t\022"
    "\027\n\017enemy_inflation\030\020 \002(\001\022\024\n\014max_occ_dist"
    "\030\021 \002(\001", 486);
...
const int ParaObstacleLayer::kMapTopicFieldNumber;
const int ParaObstacleLayer::kEnemyInflationFieldNumber;
const int ParaObstacleLayer::kMaxOccDistFieldNumber;
#endif  // !_MSC_VER
...
void ParaObstacleLayer::SharedCtor() {
  ...
  is_debug_ = false;
  map_topic_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  enemy_inflation_ = 0;
  max_occ_dist_ = 0;
...
void ParaObstacleLayer::SharedDtor() {
  ...
  if (map_topic_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete map_topic_;
  }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 14: {
        ...
        if (input->ExpectTag(122)) goto parse_map_topic;
        break;
      }

      // required string map_topic = 15;
      case 15: {
        if (tag == 122) {
         parse_map_topic:
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            this->map_topic().data(), this->map_topic().length(),
            ::google::protobuf::internal::WireFormat::PARSE,
            "map_topic");
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(129)) goto parse_enemy_inflation;
        break;
      }

      // required double enemy_inflation = 16;
      case 16: {
        if (tag == 129) {
         parse_enemy_inflation:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   double, ::google::protobuf::internal::WireFormatLite::TYPE_DOUBLE>(
                 input, &enemy_inflation_)));
          set_has_enemy_inflation();
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(137)) goto parse_max_occ_dist;
        break;
      }

      // required double max_occ_dist = 17;
      case 17: {
        if (tag == 137) {
         parse_max_occ_dist:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
...
void ParaObstacleLayer::SerializeWithCachedSizes(
  ...
  if (has_map_topic()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      "map_topic");
    ::google::protobuf::internal::WireFormatLite::WriteStringMaybeAliased(
      15, this->map_topic(), output);
  }

  // required double enemy_inflation = 16;
  if (has_enemy_inflation()) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(16, this->enemy_inflation(), output);
  }

  // required double max_occ_dist = 17;
  if (has_max_occ_dist()) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(17, this->max_occ_dist(), output);
  }
...
::google::protobuf::uint8* ParaObstacleLayer::SerializeWithCachedSizesToArray(
  ...
  if (has_map_topic()) {
    ...
    target =
      ::google::protobuf::internal::WireFormatLite::WriteStringToArray(
        15, this->map_topic(), target);
  }

  // required double enemy_inflation = 16;
  if (has_enemy_inflation()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(16, this->enemy_inflation(), target);
  }

  // required double max_occ_dist = 17;
  if (has_max_occ_dist()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(17, this->max_occ_dist(), target);
  }
...
void ParaObstacleLayer::MergeFrom(const ParaObstacleLayer& from) {
  ...
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    ...
    if (from.has_map_topic()) {
      set_map_topic(from.map_topic());
    }
    if (from.has_enemy_inflation()) {
      set_enemy_inflation(from.enemy_inflation());
    }
  }
  if (from._has_bits_[16 / 32] & (0xffu << (16 % 32))) {
    if (from.has_max_occ_dist()) {
      set_max_occ_dist(from.max_occ_dist());
    }
  }
...
void ParaObstacleLayer::Swap(ParaObstacleLayer* other) {
  if (other != this) {
    ...
    std::swap(map_topic_, other->map_topic_);
    std::swap(enemy_inflation_, other->enemy_inflation_);
    std::swap(max_occ_dist_, other->max_occ_dist_);
